...
const duser = require("./Routes/delete/d_user");
...
const dproduct = require("./Routes/delete/d_product");
...
const updateSales = require("./Routes/update/update_sales");
const updateCustomer = require("./Routes/update/update_customer");
